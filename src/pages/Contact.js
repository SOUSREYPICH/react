  ...
  return (
    <Fragment>
          ...
          <div className="row justify-content-between">
            <div className="col-lg-5">
              <div className="intro-excerpt">
                <h1>Contact</h1>
                <p className="mb-4">we are here to assist you with all your interior design needs. Whether you have questions about our services, want to schedule a consultation, or need inspiration for your next project, feel free to reach out.</p>
      ...
      <div className="untree_co-section">
		...
		<Footer/>
      <script src="js/bootstrap.bundle.min.js"></script><script src="js/tiny-slider.js"></script><script src="js/custom.js"></script>
